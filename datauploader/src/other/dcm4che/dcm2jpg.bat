...
set MAIN_JAR=dcm4che-tool-dcm2jpg-5.13.0.jar
...
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-core-5.13.0.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-net-5.13.0.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-image-5.13.0.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-imageio-5.13.0.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-imageio-opencv-5.13.0.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-imageio-rle-5.13.0.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-tool-common-5.13.0.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\weasis-opencv-core-3.0.0-RC1.jar
