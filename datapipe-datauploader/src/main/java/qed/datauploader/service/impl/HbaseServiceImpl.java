...
import qed.datauploader.factory.ThumbnailServiceFactory;
...
import qed.datauploader.tool.HBaseUtil;
...
//        DoubleFieldList.add(SysConsts.DCM_META_TAG2KW.get(SysConsts.SliceLocation_TAG));
    ...
    @Override
    public List<String> searchRowkeyByQualify(String tablename,String column, String qualify, String value) {
        if(StringUtils.isBlank(tablename) || StringUtils.isBlank(qualify) || StringUtils.isBlank(value) ){
            return null;
        }
        ...
        try {
            ...
            Filter filter = new SingleColumnValueFilter(Bytes.toBytes(column),Bytes.toBytes(qualify),
